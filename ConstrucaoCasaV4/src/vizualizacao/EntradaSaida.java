...
public class EntradaSaida {
	...
	public static int solicitaQntdAberturas(String abertura) {
		int qtdeAbertura = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade de " + abertura));

		while (qtdeAbertura <= 0) {
			JOptionPane.showMessageDialog(null, "A quantidade de portas e janelas não pode ser igual ou inferior a 0");
			qtdeAbertura = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade de " + abertura));
		}
	...
	public static void exibeMsgErro() {
		JOptionPane.showMessageDialog(null, "Você tem que construir a casa primeiro");
	}
